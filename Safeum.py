...
Ya_Bs = '\033[1;34m'
S_aBs = '\033[1;33m'
ab = pyfiglet.figlet_format("Safeum By Faizi")
print(a_bSa + ab)
...
def work():
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            print(b)
           path = "/storage/emulated/0/Safeum"
os.makedirs(path, exist_ok=True)

with open(f"{path}/safeum-Accounts.txt", "a") as f:
                f.write(username + ":mmmm | AM : @Faizi_Mods\n")
